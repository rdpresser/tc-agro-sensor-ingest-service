...
namespace TC.Agro.SensorIngest.Infrastructure.Migrations
{
    ...
    [Migration("20260304001320_AddNewFieldsSensorSnapshot")]
    partial class AddNewFieldsSensorSnapshot
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TC.Agro.SensorIngest.Domain.Snapshots.SensorSnapshot", b =>
                {
                    ...
                    b.Property<string>("PlotBoundaryGeoJson")
                        .HasColumnType("text")
                    ...
                    b.Property<double?>("PlotLatitude")
                        .HasColumnType("double precision")
                        .HasColumnName("plot_latitude");

                    b.Property<double?>("PlotLongitude")
                        .HasColumnType("double precision")
